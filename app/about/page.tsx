...
export const metadata: Metadata = {
  title: "About Natascha at My Happy Life Routine",
  description:
    "Artist, woman, traveller. This is the story behind My Happy Life Routine.",
};
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8 py-24 md:py-32 grid md:grid-cols-2 gap-14 md:gap-20 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-mhr-ink-soft leading-relaxed max-w-md">
              That same philosophy is what My Happy Life Routine shares
              with you: real life, small routines, no perfection required.
            </p>
          </div>
        </div>
      </section>
